...
function AddCategoryModal({ onDismiss, ...props }: AddMenuModalProps) {
  ...
  return (
    <Portal >
      <Modal onDismiss={onDismiss} contentContainerStyle={{ height: '100%', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', paddingHorizontal: '4%', display: 'flex' }} {...props}>
        ...
        >
          <UiText variant='headlineSmall'>Add New Category</UiText>
          <UiFormInput name="menu" control={control} label={'Category Name'}/>
